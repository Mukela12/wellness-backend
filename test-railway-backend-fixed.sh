...
# WellnessAI Backend - Railway Production Testing (Fixed Endpoints)
# Tests all endpoints on the deployed Railway backend with correct paths
...
echo "=============================================="
echo "WellnessAI Backend - Railway Testing (Fixed)"
echo "=============================================="
...
# Get Check-in Analytics (Fixed path)
...
# Get User Achievements (Fixed path)
test_endpoint "GET" "/rewards/achievements/my-achievements" "$EMPLOYEE_TOKEN" "" 200 "Get User Achievements"

# Test HR Flow
echo -e "${BLUE}Testing HR User Flow${NC}"
echo "----------------------------------------"

# 1. Register HR User (Fixed department)
...
# 3. Test HR Endpoints (Fixed paths)
echo -e "${YELLOW}3. Testing HR Analytics Endpoints${NC}"

# Get Company Overview
test_endpoint "GET" "/analytics/company-overview" "$HR_TOKEN" "" 200 "Get Company Overview"

# Get Engagement Metrics (instead of trends)
test_endpoint "GET" "/analytics/engagement" "$HR_TOKEN" "" 200 "Get Engagement Metrics"

# Get Department Analytics
test_endpoint "GET" "/analytics/department/Engineering" "$HR_TOKEN" "" 200 "Get Department Analytics"

# Get Risk Assessment
test_endpoint "GET" "/analytics/risk-assessment" "$HR_TOKEN" "" 200 "Get Risk Assessment"

# Test Admin Flow
echo -e "${BLUE}Testing Admin User Flow${NC}"
echo "----------------------------------------"

# 1. Register Admin User (Fixed department)
...
test_endpoint "GET" "/rewards/achievements/all" "$ADMIN_TOKEN" "" 200 "Get All Achievements"
